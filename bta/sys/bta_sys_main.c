...
UINT8 appl_trace_level = BT_TRACE_LEVEL_DEBUG /*BT_TRACE_LEVEL_WARNING*/; //APPL_INITIAL_TRACE_LEVEL;
UINT8 btif_trace_level = BT_TRACE_LEVEL_DEBUG/*BT_TRACE_LEVEL_WARNING*/;
